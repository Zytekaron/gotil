...
// Collisions calculates the number of samples in a given set required for there to be a
// certain probability that there will be at least one collision. See: Birthday Problem.
